...
public class UsuarioDAO {
    ...
    public Usuario getUsuario(String login) throws SQLException, UsuarioSenhaInvalidosException {
        ...
        return null;
        //throw new UsuarioSenhaInvalidosException("Usuário não cadastrado.");
    }
